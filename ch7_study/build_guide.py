...
<header class="hero">
  ...
  <p style="margin-top:18px;font-size:.95rem">
    <a href="problem_7-17.html" style="display:inline-block;background:var(--chip);color:var(--acc);padding:8px 18px;border-radius:10px;border:1px solid var(--acc);font-weight:600">
      &rarr; Worked Problem 7-17 &nbsp;&middot;&nbsp; SN1 vs E1 solvolysis in methanol
    </a>
  </p>
</header>
<div class="layout">
